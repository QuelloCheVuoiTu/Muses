...
import it.unisannio.muses.musesadmin.MainActivity
...
import it.unisannio.muses.musesadmin.data.repositories.AuthRepository
...
class LoginActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerButton.setOnClickListener {
            // For now, show a message that registration is not available
            Toast.makeText(this, "Registration not available in admin app", Toast.LENGTH_SHORT).show()
        }
    }
}
